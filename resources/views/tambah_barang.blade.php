...
<head>
  ...
  <title>Tambah Barang - Toko Hafiz Syahputra</title>
  <!-- MDB icon -->
...
<body>
  ...
  <div class="container mt-5">
      <div class="row justify-content-center">
        <div class="col-4">
          <form method="POST" action="/barang/simpan" enctype="multipart/form-data" class="rounded shadow-0 p-5">
            {{csrf_field()}}
              ...
              <b>Tambah Barang</b>
                ...
                <div class="row mt-4">
                  <div class="col d-flex justify-content-center">
                      <button onclick="alert('Data Berhasil Ditambahkan!!') "type="submit" class="btn btn-block btn-primary">SIMPAN</button>
                  </div>
                </div>
